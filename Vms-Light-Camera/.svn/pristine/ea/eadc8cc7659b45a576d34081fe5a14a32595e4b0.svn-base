...
/**
 * DateChooser Panel {@link DateTimeChooserPanel}
 */
public class DateChooser extends JPanel implements VmsIcons {
	...
	private DateChooser currentInstance = null;
		...
		datePicker.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent action) {
				if (isDialogShowing == false) {
					...
					calDialog = new CalendarDialog(currentInstance);
