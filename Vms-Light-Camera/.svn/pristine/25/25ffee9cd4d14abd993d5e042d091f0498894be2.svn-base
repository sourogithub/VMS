...
import com.dss.vms.ui.utility.VmsLookAndFeelUtil;
...
public class App {
	 ...
	 */
	public static void appInit() throws InvocationTargetException, InterruptedException {
		SwingUtilities.invokeAndWait(new Runnable() {
			@Override
			public void run() {
				VmsLookAndFeelUtil.setupLookAndFeel("Nimbus");
