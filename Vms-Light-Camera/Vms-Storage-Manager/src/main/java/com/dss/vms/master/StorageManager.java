...
public class StorageManager implements Runnable {
	private static final String LOG_FILE_NAME = "storage_activity.log";
	private static final int SLEEP_INTERVAL = 30000;
	/** 9-Gigs Default storage allocation **/
	private static final long DEFAULT_STORAGE_THRESHOLD = (long) (9 * 1024 * 1024);
	private static Object lock = new Object(); 
	private static long STORAGE_LIMIT_IN_BYTES = DEFAULT_STORAGE_THRESHOLD;
	...
	public void run() {
		 ...
		 **/
		try {STORAGE_LIMIT_IN_BYTES = (long) (getDriveUsableSpace() * 0.7);} catch (Exception e) {}
...
//										writeLog(currSession);
	...
	/**
	 * get current drive's usable space
	 * 
	 * @return
	 */
	private static File currentDrive = new File(System.getProperty("user.dir"));

	public static Long getDriveUsableSpace() {
		return currentDrive.getUsableSpace();
	}
	 ...
	 * @return
	 */
	public static Long getDirectorySize(File location) {
