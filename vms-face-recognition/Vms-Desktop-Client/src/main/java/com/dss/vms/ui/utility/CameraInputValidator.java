 ...
 * @author Sibendu
 */
public class CameraInputValidator {
	private static final String URL_REGEX = "\\b(https?|rtsp)(://)([0-9]{1,3})(\\.)([0-9]{1,3})(\\.)([0-9]{1,3})(\\.)([0-9]{1,3})([:]*)([0-9]*)/(.*)";
	private static final String IP_REGEX = "\\b([0-9]{1,3})(\\.)([0-9]{1,3})(\\.)([0-9]{1,3})(\\.)([0-9]{1,3})";
	...
	public static boolean validateStreamAddresses(String...addresses) {
		...
		try {
			for (String streamAddress : addresses) {
				success = Pattern.matches(URL_REGEX, streamAddress);
				if (!success)break;
			}
		} catch (Exception e) {
			success = false;
