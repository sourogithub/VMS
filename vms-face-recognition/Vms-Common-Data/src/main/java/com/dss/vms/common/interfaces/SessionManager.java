...
public interface SessionManager extends MediaServer {
	 ...
	 * @return
	 */
	VmsResponse createAudit(AuditType type, String desc, Long time);
	 ...
	 * @return
	 */
	VmsResponse getAuditLog(Long startTime, Long endTime);
	 ...
	 * @return
	 */
	VmsResponse getAuditLog(AuditType type, Integer limit);
	 ...
	 */
	VmsResponse getEventLog(Long startTime, Long endTime);
	 ...
	 * @return
	 */
	VmsResponse getEventLog(AnalyticType type, Integer limit);
