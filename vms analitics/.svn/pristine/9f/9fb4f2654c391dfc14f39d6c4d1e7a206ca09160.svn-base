...
CPP_SRCS += \
../dlib-19.17/tools/archive/train_face_5point_model.cpp 

OBJS += \
./dlib-19.17/tools/archive/train_face_5point_model.o 

CPP_DEPS += \
./dlib-19.17/tools/archive/train_face_5point_model.d 


# Each subdirectory must supply rules for building sources it contributes
dlib-19.17/tools/archive/%.o: ../dlib-19.17/tools/archive/%.cpp
	@echo 'Building file: $<'
