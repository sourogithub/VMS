...
CPP_SRCS += \
../dlib-19.17/dlib/http_client/http_client.cpp 

OBJS += \
./dlib-19.17/dlib/http_client/http_client.o 

CPP_DEPS += \
./dlib-19.17/dlib/http_client/http_client.d 


# Each subdirectory must supply rules for building sources it contributes
dlib-19.17/dlib/http_client/%.o: ../dlib-19.17/dlib/http_client/%.cpp
	@echo 'Building file: $<'
