...
CPP_SRCS += \
../dlib-19.17/tools/convert_dlib_nets_to_caffe/main.cpp 

OBJS += \
./dlib-19.17/tools/convert_dlib_nets_to_caffe/main.o 

CPP_DEPS += \
./dlib-19.17/tools/convert_dlib_nets_to_caffe/main.d 


# Each subdirectory must supply rules for building sources it contributes
dlib-19.17/tools/convert_dlib_nets_to_caffe/%.o: ../dlib-19.17/tools/convert_dlib_nets_to_caffe/%.cpp
	@echo 'Building file: $<'
