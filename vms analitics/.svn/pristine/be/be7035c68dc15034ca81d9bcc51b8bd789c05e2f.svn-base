...
CPP_SRCS += \
../dlib-19.17/dlib/global_optimization/global_function_search.cpp 

OBJS += \
./dlib-19.17/dlib/global_optimization/global_function_search.o 

CPP_DEPS += \
./dlib-19.17/dlib/global_optimization/global_function_search.d 


# Each subdirectory must supply rules for building sources it contributes
dlib-19.17/dlib/global_optimization/%.o: ../dlib-19.17/dlib/global_optimization/%.cpp
	@echo 'Building file: $<'
